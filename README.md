...
Also, [this](https://github.com/IEE3311-EDP-ERRI/LAB08-DAB-Optimal-Control/blob/main/DAB_files_matlab.zip) zip file contains all the codes for formulation and solution of the optimization problem for the DAB optimal design proceess and LUT obtaintion.<br>
